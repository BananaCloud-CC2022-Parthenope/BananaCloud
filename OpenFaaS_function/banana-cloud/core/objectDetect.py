...
def run(weights= 'yolov5/best.pt',  # model.pt path(s)
        source='/home/quaternione/FruitsEvaluationNet-main/yolov5/img_esempio/',  # file/dir/URL/glob, 0 for webcam
    ...
    print("num img predette: ", len(img_list))
    for img in img_list:
        print("l'img: " + img['img_name'] + " ha " + str(len(img['crop_list'])) + " crop box")
    return img_list
